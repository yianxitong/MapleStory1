...
public class Monster extends JPanel
{
	...
	public void paint(Graphics g)
	{
		...
		case 2:
		{
			...
			case 2:g.drawImage(Toolkit.getDefaultToolkit().getImage("./Í¼Æ¬ËØ²Ä/Í·Ìú¹Ö/×ß/ÊÝ×ó.gif"),x-Offsetx-39,y+Offsety-85,this);break;
			case 3:g.drawImage(Toolkit.getDefaultToolkit().getImage("./Í¼Æ¬ËØ²Ä/Í·Ìú¹Ö/×ß/ÊÝÓÒ.gif"),x-Offsetx-25,y+Offsety-85,this);break;
