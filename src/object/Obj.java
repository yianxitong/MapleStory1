...
public class Obj extends JPanel
{
	...
	//	case 34:g.drawImage(Toolkit.getDefaultToolkit().getImage("./Í¼Æ¬ËØ²Ä/Ö÷½Ç/ÂÌÉ«/µ¹¹Ò½ğ¹³2/µ¹¹Ò½ğ¹³×ó.gif"),x,y-130,this);break;
	//	case 35:g.drawImage(Toolkit.getDefaultToolkit().getImage("./Í¼Æ¬ËØ²Ä/Ö÷½Ç/ÂÌÉ«/µ¹¹Ò½ğ¹³2/µ¹¹Ò½ğ¹³ÓÒ.gif"),x,y-130,this);break;
